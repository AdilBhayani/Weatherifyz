...
var overallWeather: Array<any>;
var country: string;

var CurrentMenu: any = initialContainer;
var menuOption: number = 0;

var futureTemperature: Array<any> = [];
var futureHumidity: Array<number> = [];
var futureWindSpeed: Array<number> = [];
...
function weatherCaller(option, callback, callback2): void {
    ...
    $.ajax({
        ...
        .done(function (data) {
            if (data.cod != 404) { // if data is received
                // Get the temperature
                var mainInfo = data;

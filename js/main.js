...
function imageChooser(option) {
    ...
    if (icons == '01d') {
        ...
        image.src = "http://res.freestockphotos.biz/pictures/15/15149-illustration-of-the-full-moon-pv.png";
    }
    else if (icons == '02d') {
        image.src = "http://res.freestockphotos.biz/pictures/15/15148-illustration-of-the-sun-with-clouds-pv.png";
    }
    else if (icons == '02n') {
        image.src = "http://res.freestockphotos.biz/pictures/15/15150-illustration-of-the-full-moon-with-clouds-pv.png";
    }
    else if (icons.slice(0, 2) == "03" || icons.slice(0, 2) == "04") {
        image.src = "http://res.freestockphotos.biz/pictures/15/15146-illustration-of-a-stormy-cloud-pv.png";
    }
    else if (icons.slice(0, 2) == "09" || icons.slice(0, 2) == "10") {
        image.src = "http://res.freestockphotos.biz/pictures/15/15143-illustration-of-a-stormy-cloud-with-light-rain-pv.png";
    }
    else if (icons.slice(0, 2) == "11") {
        image.src = "http://res.freestockphotos.biz/pictures/15/15141-illustration-of-a-stormy-cloud-with-lightning-pv.png";
    }
    else if (icons.slice(0, 2) == "13") {
        image.src = "http://res.freestockphotos.biz/pictures/15/15142-illustration-of-a-stormy-cloud-with-snow-pv.png";
    }
    else if (icons.slice(0, 2) == "50") {
        image.src = "http://res.freestockphotos.biz/pictures/15/15145-illustration-of-a-stormy-cloud-with-a-warning-symbol-pv.png";
    }
    else
        image.src = "http://res.freestockphotos.biz/pictures/15/15147-illustration-of-the-sun-pv.png";
}
